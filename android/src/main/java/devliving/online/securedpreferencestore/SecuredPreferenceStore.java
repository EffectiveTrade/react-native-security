...
import ru.eftr.RNSecurity.BuildConfig;
...
public class SecuredPreferenceStore implements SharedPreferences {
    ...
    public Exception pullException() {
        Exception ex = mException;
        mException = null;
        return ex;
    }
    ...
    public void throwExceptionIfErrorOccurred() throws Exception {
        Exception ex = pullException();
        if (ex != null) {
            throw ex;
        }
    }
